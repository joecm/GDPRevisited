...
SpriteSheet::SpriteSheet(TextureManager* l_textMgr) : m_textureManager(l_textMgr), 
    m_spriteScale(1.f,1.f), m_direction(Direction::Right), m_animationCurrent(nullptr)
{
}
...
{
    m_spriteSize = l_size;
    m_sprite.setOrigin(m_spriteSize.x/2u, m_spriteSize.y);
}
